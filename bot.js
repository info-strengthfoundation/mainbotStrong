...
const mainMenu = Markup.keyboard([
    ...
    ["🎫 Квитки у заклади дозвілля", "💚 Разом Далі"],
    ["🎠 Заходи для дітей", "💰 Підтримати фонд"]
]).resize()
// 🔥 ГЛОБАЛЬНЕ ПОВЕРНЕННЯ В ГОЛОВНЕ МЕНЮ + RESET STATE
bot.hears(
    [
        "↩️ Повернутися назад",
        "↩️ Назад",
    ...
    ctx => {
        delete userState[ctx.from.id]; // 💣 головний фікс
