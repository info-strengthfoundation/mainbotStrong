...
export default function (bot, mainMenu, userState) {
    ...
    bot.hears("🎫 Квитки у заклади дозвілля", async ctx => {
        ...
        await ctx.reply(
            "Наш фонд разом із партнерами дарує безоплатні квитки на культурні, освітні та розважальні події у різні заклади дозвілля. " +
            "Це можливість провести час з рідними та створити нові теплі спогади.\n\n" +
            "Щоб переглянути актуальні події, оберіть дію нижче 👇",
            Markup.keyboard([
