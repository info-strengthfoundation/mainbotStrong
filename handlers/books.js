...
export default function (bot, mainMenu, userState) {
    ...
    bot.hears("📚 Книжки", (ctx) => {
        ctx.reply(
            "Книги — це спосіб відволіктися від постійної тривоги й очікування. " +
            "Саме тому наш фонд постійно передає книжки для дорослих і дітей з родин військовополонених та зниклих безвісти.\n\n" +
            "Оберіть книгу з наявного списку — ми з радістю передамо її вам або вашим рідним 👇",
            Markup.keyboard([
